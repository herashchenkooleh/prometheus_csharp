...
TriangleRenderer::TriangleRenderer() : Renderer(), m_pd3dVB(NULL)
{
}
...
HRESULT TriangleRenderer::Create(IDirect3D9 *pD3D, IDirect3D9Ex *pD3DEx, HWND hwnd, UINT uAdapter, Renderer **ppRenderer)
{
	HRESULT hr = S_OK;
...
HRESULT TriangleRenderer::Init(IDirect3D9 *pD3D, IDirect3D9Ex *pD3DEx, HWND hwnd, UINT uAdapter)
{
	HRESULT hr = S_OK;
	...
	IFC(Renderer::Init(pD3D, pD3DEx, hwnd, uAdapter));
